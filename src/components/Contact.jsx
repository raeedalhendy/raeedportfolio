    ...
    <section id="contact" className="contact section section-alt">
      <div className="container" ref={ref}>
        <div className={`contact__header ${isVisible ? 'contact__header--visible' : ''}`}>
          <h2 className="contact__title">تواصل معي</h2>
          <p className="contact__subtitle">يسعدني الاستماع إلى فكرتك ومناقشة تفاصيلها</p>
        </div>

        <motion.div
          className={`contact__buttons ${isVisible ? 'contact__buttons--visible' : ''}`}
        ...
        >
          ...
          <motion.a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="contact__btn contact__btn--telegram"
            whileHover={{ y: -4, scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
          >
            <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
